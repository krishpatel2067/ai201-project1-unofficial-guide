...
#1  distance=0.3294  source=martin-kellogg.txt  type=review  id=martin-kellogg-review-3
    Course: CS485
...
#2  distance=0.4042  source=martin-kellogg.txt  type=overall  id=martin-kellogg-overall
...
#3  distance=0.5110  source=samaneh-berenjian.txt  type=review  id=samaneh-berenjian-review-83
    Course: CS696
...
#4  distance=0.5163  source=kumar-mani.txt  type=review  id=kumar-mani-review-26
    Course: CS356
...
#5  distance=0.5195  source=kumar-mani.txt  type=review  id=kumar-mani-review-69
    Course: CS636
